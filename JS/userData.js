...
async function fetchUserData() {
    try {
        ...
        const userTokenPerSecond = Math.ceil(data.tokens_per_second)
        const userTokenPerTap = Math.ceil(data.tokens_per_tap)
        const userWaterPerMinute = data.water_per_minute
